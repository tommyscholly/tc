...
impl TestFixture {
    ...
    /// Get the source without comments and extra whitespace (for comparison)
...
/// Test utilities for lexing
pub mod lex_utils {
    use super::*;

    /// Assert that a fixture can be tokenized without errors
    ...
    /// Assert that a fixture contains specific tokens
    ...
    /// Count occurrences of a specific token
...
pub mod parse_utils {
    ...
    /// Assert that a fixture can be parsed without errors
    ...
    /// Assert that a fixture contains a specific number of definitions
    ...
    /// Assert that a fixture contains data definitions
    ...
    /// Assert that a fixture contains function definitions
    ...
    /// Assert that a fixture contains extern function definitions
    ...
    /// Get a function by name from a parsed program
    ...
    /// Assert that a function has a specific number of blocks
...
pub mod error_utils {
    ...
    /// Assert that a source string fails to tokenize
